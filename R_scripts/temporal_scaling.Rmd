...
* Compute mean number of measurements by collar and month for discussion
...
#  select(-V1, -V4) %>% 
  ...
  # What the heck--it appears chamber 8 was miswired at some point; temperature data is in V1
  mutate(T5 = if_else(T5 > 100, V1, T5)) %>% 
