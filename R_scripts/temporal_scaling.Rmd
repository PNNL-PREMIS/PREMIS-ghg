...
save_plot("temporal_figures/Figure4-daily_pacf.png", plot = p)
```
...
cld_24hr_errors$Season <- seasons[cld_24hr_errors$Month]
...
save_plot("temporal_figures/Figure3-time_of_day.png", plot = p)
```
...
p1title <- paste("O. Effect of m. interval and annual coverage, N =",
...
p <- ggplot(smry, aes(Seconds, CV, label = Labels, group = Labels)) +
