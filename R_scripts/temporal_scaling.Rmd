...
* Best time of day to sample: Cueva et al. (2017), (many others, especially Chinese authors)
* Temporal density of sampling depends on ultimate goal (Savage et al. 2008)
* Temporal patterns shift with e.g. presence of roots and canopy (Savage et al. 2013)
...
ggplot(cld_cv, aes(x = CV)) + geom_histogram(bins = 20) +
  ...
  ggtitle(paste("I. Daily CV, N =", nrow(cld_cv)))
```
