...
imp <- relaimpo::calc.relimp(h1_lin$reduced_model, type = "lmg", rela = TRUE)
...
imp <- relaimpo::calc.relimp(h2g$reduced_model, type = "lmg", rela = TRUE)
print(imp, show.coeffs = FALSE)
print(round(sort(imp$lmg, decreasing = TRUE), 2))
...
imp <- relaimpo::calc.relimp(h2d$reduced_model, type = "lmg", rela = TRUE)
print(imp, show.coeffs = FALSE)
print(round(sort(imp$lmg, decreasing = TRUE), 2))
```
...
imp <- relaimpo::calc.relimp(h3l$reduced_model, type = "lmg", rela = TRUE)
print(imp, show.coeffs = FALSE)
print(round(sort(imp$lmg, decreasing = TRUE), 2))
...
imp <- relaimpo::calc.relimp(h3h$reduced_model, type = "lmg", rela = TRUE)
print(imp, show.coeffs = FALSE)
print(round(sort(imp$lmg, decreasing = TRUE), 2))
```
