...
# This function runs prox_model() and returns plots
run_model <- function(data, model_type) {
...
h1 <- run_model(control_cols_5m, model_type = "linear")
```
...
print(m_limited)
h3l <- run_model(m_limited, model_type = "linear")
  
m_ample <- filter(control_cols_5m, SOILMOISTURE >= SMOISTURE_MEDIAN)
print(m_ample)
h3a <- run_model(m_ample, model_type = "linear")
