...
h2g <- with(growing_flux, prox_model(Flux, T5, T20, SMoisture, BA_m2, 
                                     site = Dest_Salinity, model_type = "linear"))
...
print(dormant_flux)
h2d <- with(dormant_flux, prox_model(Flux, T5, T20, SMoisture, BA_m2, 
                                     site = Dest_Salinity, model_type = "linear"))
...
for (i in seq.int(2, max(tree_prox_data$Distance_m))) {
  ...
  mods <- with(data, prox_model(Flux, T5, T20, SMoisture, BA_m2, 
