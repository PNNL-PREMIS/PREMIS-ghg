...
growing_flux <- filter(control_cols_5m, Timestamp > "2018-04-15 00:00:00", Timestamp < "2018-10-14 23:59:59")

h2g <- with(growing_flux, prox_model(Flux, T5, T20, SMoisture, BA_m2, Site))

# Filter true controls for dormant season
dormant_flux <- filter(control_cols_5m, Timestamp > "2018-10-15 00:00:00", Timestamp < "2018-04-14 23:59:59")
