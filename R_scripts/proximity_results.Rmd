...
print_var_importance <- function(m) {
...
print_var_importance(h1_lin$reduced_model)
```
...
print_var_importance(h2g$reduced_model)
...
print_var_importance(h2d$reduced_model)
```
...
print_var_importance(h3l$reduced_model)
...
print_var_importance(h3h$reduced_model)
```
